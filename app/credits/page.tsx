    ...
    <section id="versions">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 text-gray-400">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto md:pb-16">
            <h3 className="h3 mb-3 text-gray-400">Open Source Code</h3>
            <p>A lots of applications, protocols and libraries have been and are being used at this project. To list few:</p>
            <div>
              <ul>
                <li>Linux (Ubuntu)</li>

  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 text-gray-400">
      <div className="py-12 md:py-20 border-t border-gray-800">
        ...
        <div className="mb-12">
          <h1 className="h1 mb-6 text-purple-600">{codename.name} ({codename.type})</h1>
          <table>
            <tbody>
              <tr><td className="pr-4">Date</td><td>{codename.date}</td></tr>
              <tr><td className="pr-4">Backend</td><td>v.{codename?.backend?.version}</td></tr>
              <tr><td className="pr-4">Frontend</td><td>v.{codename?.frontend?.version}</td></tr>
            </tbody>
          </table>
        ...
        <div className="mb-12">
          ...
          <div className="">{ show({visible: serverVisible, topic: "Server (Backend)", toggleVisibility: toggleServer, id: "server", versions: server_versions}) }</div>
          <div className="">{ show({visible: clientVisible, topic: "Client (Frontend)", toggleVisibility: toggleClient, id: "client", versions: client_versions}) }</div>
        </div>
